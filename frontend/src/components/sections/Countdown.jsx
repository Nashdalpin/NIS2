...
const Cell = ({ value, label, gold = false }) => (
  <div className="text-center min-w-[70px]">
    <div
      className={`font-cinzel text-3xl md:text-5xl leading-none ${
...
export const Countdown = () => {
  ...
  return (
    <section
      ...
      className="py-20 lg:py-28 px-6 bg-[#070707] border-y border-white/10 relative overflow-hidden"
    >
      <div
      ...
      />
      <div className="max-w-6xl mx-auto relative z-10 grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div>
          <p className="micro-label mb-5 text-[9px]">
            Cronómetro Regulatório · Tempo Real
          </p>
          <h2 className="font-cinzel text-3xl md:text-4xl lg:text-5xl leading-[1.15] tracking-tight">
            O prazo já passou.
            <br />
            <span className="gold-text">A vigilância continua.</span>
          </h2>
          <p className="font-outfit text-white/55 text-base mt-6 leading-relaxed max-w-md">
        ...
        <div className="space-y-10">
          <div>
            <p className="text-[10px] uppercase tracking-[0.4em] text-[#bf953f] mb-5">
          ...
          <div>
            ...
            <div className="flex items-end gap-4 md:gap-6 opacity-80">
