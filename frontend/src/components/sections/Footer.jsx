...
export const Footer = () => (
  <footer
    ...
    className="border-t border-white/10 bg-[#030303] pt-14 md:pt-20 pb-8 md:pb-10 px-5 sm:px-6"
  >
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-2 lg:grid-cols-12 gap-8 md:gap-12 mb-10 md:mb-16">
        <div className="col-span-2 lg:col-span-5 space-y-5 md:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 pt-3 md:pt-4">
            <span className="text-[10px] uppercase tracking-[0.4em] text-[#bf953f]">
              Member of
            </span>
            <span className="text-[10px] uppercase tracking-[0.25em] sm:tracking-[0.3em] text-white/50">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <ul className="space-y-2.5 md:space-y-3 font-outfit text-sm">
      ...
      <div className="border-t border-white/10 pt-6 md:pt-8 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4 text-center md:text-left">
        <p className="text-[9px] sm:text-[10px] uppercase tracking-[0.25em] sm:tracking-[0.3em] text-white/30">
